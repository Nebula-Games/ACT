///-------------------------------------------------------------------------------------------------
// file:	Windows\Security\Elevation.cs
//
// summary:	Implements the elevation class
///-------------------------------------------------------------------------------------------------
...
using ACT.Core.Consts.Windows.Security;
...
#region Helper Functions for Admin Privileges and Elevation Status 
        ...
        public static bool IsUserInAdminGroup()
        {
            ...
            try
            {
                ...
                if (!NativeMethods.OpenProcessToken(Process.GetCurrentProcess().Handle,
                    TOKENCONSTANTS.TOKEN_QUERY | TOKENCONSTANTS.TOKEN_DUPLICATE, out hToken))
                {
        ...
        public static bool IsProcessElevated()
        {
            ...
            try
            {
                ...
                if (!NativeMethods.OpenProcessToken(Process.GetCurrentProcess().Handle,
                    TOKENCONSTANTS.TOKEN_QUERY, out hToken))
                {
                    throw new Win32Exception();
                }
        ...
        public static int GetProcessIntegrityLevel()
        {
            ...
            try
            {
                    ...
                    out cbTokenIL))
                {
                    ...
                    if (error != TOKENCONSTANTS.ERROR_INSUFFICIENT_BUFFER)
                    {
