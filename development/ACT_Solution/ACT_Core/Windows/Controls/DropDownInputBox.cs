/////-------------------------------------------------------------------------------------------------
//// file:	Windows\Controls\DropDownInputBox.cs
////
//// summary:	Implements the drop down input box class
/////-------------------------------------------------------------------------------------------------
...
//        private static ComboBox txtInput;

//        public DropDownInputBox()
//        {
//        }
...
//        static public InputBoxResult Show(string Prompt, List<string> ComboData)
//        {
//            InitializeComponent();
//            FormPrompt = Prompt;
//            LoadCombo(ComboData);
...
//        static public InputBoxResult Show(string Prompt, string Title, List<string> ComboData)
//        {
//            InitializeComponent();
//            LoadCombo(ComboData);
//            FormCaption = Title;
...
//        static public InputBoxResult Show(string Prompt, string Title, string Default, List<string> ComboData)
//        {
//            InitializeComponent();
//            LoadCombo(ComboData);
//            FormCaption = Title;
...
//        static public InputBoxResult Show(string Prompt, string Title, string Default, int XPos, int YPos, List<string> ComboData)
//        {
//            InitializeComponent();
//            LoadCombo(ComboData);
//            FormCaption = Title;
...
//        private static void LoadCombo(List<string> cmboData)
//        {
//            txtInput.Items.Clear();

//            foreach (string itm in cmboData)
//            {
//                txtInput.Items.Add(itm);
//            }
//        }
