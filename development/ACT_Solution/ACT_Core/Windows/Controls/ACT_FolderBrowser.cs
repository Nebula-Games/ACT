///-------------------------------------------------------------------------------------------------
// file:	Windows\Controls\ACT_FolderBrowser.cs
//
// summary:	Implements the act folder browser class
///-------------------------------------------------------------------------------------------------
...
namespace ACT.Core.Windows.Controls
{
#if DOTNETFRAMEWORK
    ///-------------------------------------------------------------------------------------------------
    /// <summary>   A folder browser dialog ex. </summary>
    ///
    /// <remarks>   Mark Alicz, 10/4/2019. </remarks>
    ///-------------------------------------------------------------------------------------------------

    public class ACT_FolderBrowser
    {
    #region Fields that mimic the same-named fields in FolderBrowserDialog
        ...
        ///-------------------------------------------------------------------------------------------------
        /// <summary>   Gets or sets the full pathname of the selected file. </summary>
        ///
        /// <value> The full pathname of the selected file. </value>
        ///-------------------------------------------------------------------------------------------------
        ...
        ///-------------------------------------------------------------------------------------------------
        /// <summary>   Gets or sets a value indicating whether the editbox is shown. </summary>
        ///
        /// <value> True if show editbox, false if not. </value>
        ///-------------------------------------------------------------------------------------------------
        ...
        ///-------------------------------------------------------------------------------------------------
        /// <summary>   A control identifiers. </summary>
        ///
        /// <remarks>   Mark Alicz, 10/4/2019. </remarks>
        ///-------------------------------------------------------------------------------------------------
        ...
        private struct CtlIds
        {
            ...
            /// <summary>   The new folder button. </summary>
            public const int NEW_FOLDER_BUTTON = 0x3746;
            /// <summary>   The idok. </summary>
            public const int IDOK = 1;
            /// <summary>   The idcancel. </summary>
            public const int IDCANCEL = 2;
        }

        ///-------------------------------------------------------------------------------------------------
        /// <summary>   An initialize data. </summary>
        ///
        /// <remarks>   Mark Alicz, 10/4/2019. </remarks>
        ///-------------------------------------------------------------------------------------------------
        ...
        public struct InitData
        {
            ...
            /// <summary>   Full pathname of the initial file. </summary>
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = Win32.MAX_PATH)]
            public string InitialPath;

            /// <summary>   True to show, false to hide the editbox. </summary>
            public bool ShowEditbox;
            /// <summary>   True to show, false to hide the new folder button. </summary>
            ...
            /// <param name="hParent">  The parent. </param>
            ///-------------------------------------------------------------------------------------------------

            public InitData(ACT_FolderBrowser dlg, IntPtr hParent)
            {
        ...
        ///-------------------------------------------------------------------------------------------------
        /// <summary>   Handler, called when the browse callback. </summary>
        ///
        /// <remarks>   Mark Alicz, 10/4/2019. </remarks>
        ///
        ...
        ///-------------------------------------------------------------------------------------------------
        /// <summary>   Adjust user interface. </summary>
        ///
        /// <remarks>   Mark Alicz, 10/4/2019. </remarks>
        ///
        /// <param name="hDlg">     The dialog. </param>
