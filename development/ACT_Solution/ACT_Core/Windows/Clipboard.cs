///-------------------------------------------------------------------------------------------------
// file:	Windows\Clipboard.cs
//
// summary:	Implements the clipboard class
///-------------------------------------------------------------------------------------------------
    ...
    public class Clipboard
    {
        ...
        public class Result
        {
            ...
            public bool OK
            {
                ...
                get { return Clipboard.ResultCode.Success == ResultCode; }
            }
        }
        ...
        {
            var isAscii = (message != null && (message == System.Text.Encoding.ASCII.GetString(System.Text.Encoding.ASCII.GetBytes(message))));
            if (isAscii)
            {
