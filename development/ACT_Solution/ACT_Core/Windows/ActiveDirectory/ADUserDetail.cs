///-------------------------------------------------------------------------------------------------
// file:	Windows\ActiveDirectory\ADUserDetail.cs
//
// summary:	Implements the ad user detail class
///-------------------------------------------------------------------------------------------------
...
namespace ACT.Core.Windows.ActiveDirectory
{
    public class ADUserDetail
    {
        ...
        public ADUserDetail Manager(string LDAPPath)
        {
            ...
            if (!String.IsNullOrEmpty(_managerName))
            {
                ...
                return ad.GetUserByFullName(_managerName, LDAPPath);
#endif
            }
            return null;
