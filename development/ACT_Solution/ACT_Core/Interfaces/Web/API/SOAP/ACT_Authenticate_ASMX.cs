///-------------------------------------------------------------------------------------------------
// file:	Web\API\SOAP\ACT_Authenticate_ASMX.cs
//
// summary:	Implements the act authenticate asmx class
///-------------------------------------------------------------------------------------------------
...
namespace ACT.Core.Web.API.SOAP
{
    public class CALL_SOAP_METHOD
    {
        ...
        public CALL_SOAP_METHOD()
        {

        }

        public CALL_SOAP_METHOD(string url, string methodName)
        {
            Url = url;
