...
namespace ACT.Core.Helper.Security.ACTLicense
{
	public class CryptoHelper
	{
		...
		public CryptoHelper(string algorithmName, string key)
		{
			...
			provider.Key = System.Text.Encoding.UTF8.GetBytes(key);
		...
		public string Decrypt(string encryptedText)
		{
			...
			var clearText =
				System.Text.Encoding.UTF8.GetString(buffer, 0, (int) clearStream.Length);
		...
		{
			var clearBuffer = System.Text.Encoding.UTF8.GetBytes(clearText);
