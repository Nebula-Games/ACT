...
namespace ACT.Plugins.Security.Encryption
{
    ...
    /// </summary>
    public class ACT_KriptoC : I_Encryption
    {
        internal string _EncryptionKey { get { return ACT.Core.SystemSettings.GetSettingByName("InternalEncryptionKey").Value; } }
        ...
        {
            if (ACT.Core.SystemSettings.SettingKeys.Contains("InternalEncryptionKey") == false) { return false; }
            else { return true; }
        }
